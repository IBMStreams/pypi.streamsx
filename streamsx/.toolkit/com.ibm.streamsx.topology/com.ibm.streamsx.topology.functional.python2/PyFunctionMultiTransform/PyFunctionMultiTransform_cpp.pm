...
package PyFunctionMultiTransform_cpp;
...
sub main::generate($$) {
   ...
   print '{', "\n";
   print '    streamsx::topology::PyGILLock lock;', "\n";
   print '    streamsx::topology::Splpy::flush_PyErrPyOut();', "\n";
   print '}', "\n";
   print "\n";
   ...
   print '    PyObject * pyArg = streamsx::topology::pyAttributeToPyObject(value);', "\n";
   print "\n";
   print '    PyObject * pyIterator = streamsx::topology::Splpy::pyTupleFunc(function_, pyArg);', "\n";
   print "\n";
   print '    if (pyIterator == 0) {', "\n";
   print '      streamsx::topology::Splpy::flush_PyErr_Print();', "\n";
   print '      throw;', "\n";
   print '    }', "\n";
   print '    if (pyIterator == Py_None) {', "\n";
   ...
   print '      long int size = PyBytes_Size(item);', "\n";
   print '      char * bytes = PyBytes_AsString(item);', "\n";
