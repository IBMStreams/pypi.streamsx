...
setup(
  name = 'streamsx',
  packages = ['streamsx', 'streamsx.spl', 'streamsx.topology', 'streamsx.scripts'],
  ...
  download_url = 'https://github.com/IBMStreams/pypi.streamsx/tarball/1.8.0b1',
  ...
  entry_points = {
        'console_scripts': ['streamsx-runner=streamsx.scripts.runner:main'],
  },
)
